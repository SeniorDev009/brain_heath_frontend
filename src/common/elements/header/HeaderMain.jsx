...
export const HeaderMain = ({ pClass, darkLogo, lightLogo }) => {
  ...
  return (
    <>
      <header className={`header mt-4 axil-header ${pClass || ''}`}>
          ...
          <div className="row justify-content-between align-items-center">
            ...
            <div className="col-xl-3 col-lg-8 col-md-8 col-sm-9 col-12">
              <div className="header-search text-end d-flex align-items-center">
                <form className="header-search-form d-sm-block d-none" style={{ visibility: 'hidden' }}>
